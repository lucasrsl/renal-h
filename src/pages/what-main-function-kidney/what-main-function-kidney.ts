...
/**
 * Generated class for the WhatMainFunctionKidneyPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-what-main-function-kidney',
  templateUrl: 'what-main-function-kidney.html',
})
export class WhatMainFunctionKidneyPage {
  translation: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController, public renderer: Renderer, public viewCtrl: ViewController, private platform: Platform, private translate: TranslateService) {
    ...
    this.translate.get("WHAT_MAIN_FUNCTION_KIDNEY").subscribe((res)=>{
      this.translation = res;
    });
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad WhatMainFunctionKidneyPage');
