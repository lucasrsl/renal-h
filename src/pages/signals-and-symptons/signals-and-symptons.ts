...
/**
 * Generated class for the SignalsAndSymptonsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-signals-and-symptons',
  templateUrl: 'signals-and-symptons.html',
})
export class SignalsAndSymptonsPage {
  translation: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController, public renderer: Renderer, public viewCtrl: ViewController, private platform: Platform, private translate: TranslateService) {
    ...
    this.translate.get("SIGNAL_AND_SYMPTONS").subscribe((res)=>{
      this.translation = res;
    });
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad SignalsAndSymptonsPage');
  ...
  openInformation(){
    let information = this.alertCtrl.create({
      ...
      message: '<p>'+ this.translation.ALERT.MESSAGE1 + '<br/>'+ this.translation.ALERT.MESSAGE2 +'</p>',
