...
/**
 * Generated class for the PreventDrcPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-prevent-drc',
  templateUrl: 'prevent-drc.html',
})
export class PreventDrcPage {
  translation: any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PreventDrcPage');
