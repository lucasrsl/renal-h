...
/**
 * Generated class for the TransplantedDoubtsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-transplanted-doubts',
  templateUrl: 'transplanted-doubts.html',
})
export class TransplantedDoubtsPage {
  translation: any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad TransplantedDoubtsPage');
