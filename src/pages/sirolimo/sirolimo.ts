...
/**
 * Generated class for the SirolimoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-sirolimo',
  templateUrl: 'sirolimo.html',
})
export class SirolimoPage {
  translation: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public viewCtrl: ViewController, public alertCtrl: AlertController, public renderer:Renderer, private platform: Platform, private translate: TranslateService) {
    ...
    this.translate.get("SIROLIMO").subscribe((res)=>{
      this.translation = res;
    });
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad SirolimoPage');
