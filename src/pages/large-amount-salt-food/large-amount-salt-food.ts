...
/**
 * Generated class for the LargeAmountSaltFoodPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-large-amount-salt-food',
  templateUrl: 'large-amount-salt-food.html',
})
export class LargeAmountSaltFoodPage {
  translation: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController, public viewCtrl: ViewController, public renderer: Renderer, private platform: Platform, private translate: TranslateService) {
    ...
    this.translate.get('LARGE_AMOUNT_SALT_FOOD').subscribe((res)=>{
      this.translation = res;
    });
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad LargeAmountSaltFoodPage');
