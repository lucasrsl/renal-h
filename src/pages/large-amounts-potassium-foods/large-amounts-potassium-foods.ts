...
/**
 * Generated class for the LargeAmountsPotassiumFoodsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-large-amounts-potassium-foods',
  templateUrl: 'large-amounts-potassium-foods.html',
})
export class LargeAmountsPotassiumFoodsPage {
  translation: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController, public viewCtrl:ViewController, public renderer:Renderer, private platform: Platform, private translate: TranslateService) {
    ...
    this.translate.get('LARGE_AMOUNT_POTASSIUM_FOODS').subscribe((res)=>{
      this.translation = res;
    });
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad LargeAmountsPotassiumFoodsPage');
