...
/**
 * Generated class for the IntercurrenHemodialysisPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-intercurren-hemodialysis',
  templateUrl: 'intercurren-hemodialysis.html',
})
export class IntercurrenHemodialysisPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad IntercurrenHemodialysisPage');
