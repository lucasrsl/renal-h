...
/**
 * Generated class for the MicofenolatoSodicoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-micofenolato-sodico',
  templateUrl: 'micofenolato-sodico.html',
})
export class MicofenolatoSodicoPage {
  translation: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public viewCtrl: ViewController, public alertCtrl: AlertController, public renderer: Renderer, private platform: Platform, private translate: TranslateService) {
    ...
    this.translate.get("MICOFENOLATO_SODICO").subscribe((res)=>{
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad MicofenolatoSodicoPage');
