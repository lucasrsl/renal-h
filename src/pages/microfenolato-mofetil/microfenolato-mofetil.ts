...
/**
 * Generated class for the MicrofenolatoMofetilPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-microfenolato-mofetil',
  templateUrl: 'microfenolato-mofetil.html',
})
export class MicrofenolatoMofetilPage {
  translation: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public viewCtrl: ViewController, public alertCtrl: AlertController , public renderer: Renderer, private platform: Platform, private translate: TranslateService) {
    ...
    this.translate.get("MICROFENOLATO_MOFETIL").subscribe((res)=>{
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad MicrofenolatoMofetilPage');
