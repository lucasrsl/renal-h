...
/**
 * Generated class for the MainCausesDrcPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-main-causes-drc',
  templateUrl: 'main-causes-drc.html',
})
export class MainCausesDrcPage {
  translation: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController, public viewCtrl: ViewController, public renderer: Renderer, private platform: Platform, private translate : TranslateService) {
    ...
    this.translate.get("MAIN_CAUSES_DRC").subscribe((res)=>{
      this.translation = res
    });
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad MainCausesDrcPage');
