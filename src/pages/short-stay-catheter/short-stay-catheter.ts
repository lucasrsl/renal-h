...
/**
 * Generated class for the ShortStayCatheterPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-short-stay-catheter',
  templateUrl: 'short-stay-catheter.html',
})
export class ShortStayCatheterPage {
  translation: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController, public viewCtrl: ViewController, public renderer: Renderer, private platform: Platform, private translate: TranslateService) {
    ...
    this.translate.get("SHORT_STAY_CATHETER").subscribe((res)=>{
      this.translation = res;
    });
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad ShortStayCatheterPage');
