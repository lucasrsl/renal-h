...
/**
 * Generated class for the TransplantedNutritionalRecommendationPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-transplanted-nutritional-recommendation',
  templateUrl: 'transplanted-nutritional-recommendation.html',
})
export class TransplantedNutritionalRecommendationPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad TransplantedNutritionalRecommendationPage');
