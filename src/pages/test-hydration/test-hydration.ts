...
/**
 * Generated class for the TestHydrationPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-test-hydration',
  templateUrl: 'test-hydration.html',
})
export class TestHydrationPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad TestHydrationPage');
